        ...
        <div class="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div class="space-y-8 lg:col-span-7">
                <div x-data="{ show: false }" x-init="setTimeout(() => show = true, 100)"
                    ...
                    <div class="mt-6">
                        <a href="{{ ($hero && $hero->sk_pdf) ? $hero->sk_pdf_url : '#' }}" 
                           @if($hero && $hero->sk_pdf) target="_blank" @endif
                           class="inline-flex items-center gap-2.5 bg-amber-50 hover:bg-amber-100 text-amber-800 border border-amber-200/60 font-bold rounded-2xl px-6 py-3.5 text-sm transition-all duration-300 hover:scale-[1.02] active:scale-95 shadow-sm">
                            <svg class="w-5 h-5 text-amber-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                            </svg>
                            SK Sertifikasi Jarak Jauh LSP SEN
                        </a>
                    </div>
                </div>
            </div>
