...
@section('title', 'Tambah Statistik Kelulusan')
...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="font-display text-2xl font-bold text-gray-900">Tambah Program Statistik</h1>
    </div>
        ...
        <form action="{{ route('admin.statistics.store') }}" method="POST">
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="nama_program" value="{{ old('nama_program') }}" required placeholder="Contoh: OKUPASI INSTRUKTUR (LEVEL 4)"
                ...
                <div class="grid sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="peserta_kompeten" value="{{ old('peserta_kompeten', 0) }}" required min="0"
                               class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary/30 outline-none">
                    ...
                    <div>
                        ...
                        <input type="number" name="peserta_belum_kompeten" value="{{ old('peserta_belum_kompeten', 0) }}" required min="0"
                               class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary/30 outline-none">
