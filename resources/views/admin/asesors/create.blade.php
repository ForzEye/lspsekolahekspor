...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="font-display text-2xl font-bold text-gray-900">Tambah Asesor</h1>
    </div>
        ...
        <form action="{{ route('admin.asesors.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required placeholder="Contoh: Dr. John Doe, M.Ak."
                ...
                <div>
                    ...
                    <input type="text" name="position" value="{{ old('position') }}" required placeholder="Contoh: Asesor Kompetensi Ekspor"
                           class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary/30 outline-none">
                </div>
            ...
            <div class="flex items-center gap-3 mt-8 pt-6 border-t border-gray-100">
                <button type="submit" class="bg-accent hover:bg-accent-dark text-white font-bold px-8 py-3.5 rounded-xl text-sm transition-all duration-200 shadow-md">Simpan Asesor</button>
            </div>
        </form>
    </div>
</div>
