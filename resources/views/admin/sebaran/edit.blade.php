                ...
                <div class="relative" x-data="{ open: false }" @click.away="open = false">
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute right-4 top-1/2 -translate-y-1/2 flex items-center gap-2">
                            ...
                            <svg class="w-4 h-4 text-gray-455 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-xs text-gray-455 mt-1.5">💡 Sistem mencari otomatis koordinat Latitude & Longitude resmi dari database geolokasi.</p>
                    @error('nama_wilayah')
